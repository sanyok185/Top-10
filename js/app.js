(() => {
    ...
    function formRating() {
        ...
        if (document.getElementsByClassName("rating__number")) {
            const ratingNumbers = document.querySelectorAll(".rating__number");
            for (let number of ratingNumbers) {
                const ratingValue = number.parentElement.getAttribute("data-rating-value");
                number.innerHTML = `${ratingValue}/5.0`;
            }
        }
    }
    ...
    function initSliders() {
        if (document.querySelector(".promotions__slider")) new swiper_core_Swiper(".promotions__slider", {
            ...
            pagination: {
                el: ".promotions__slider .swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
    ...
    da.init();
    if (document.querySelector(".form-question__placeholder")) {
        const inputElements = document.querySelectorAll(".form-question__input");
        const placeholderElements = document.querySelectorAll(".form-question__placeholder");
        inputElements.forEach(((inputElement, index) => {
            inputElement.addEventListener("input", (function() {
                if (inputElement.value.trim() !== "") placeholderElements[index].classList.add("hidden"); else placeholderElements[index].classList.remove("hidden");
            }));
        }));
    }
    let script_requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame;
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        window.addEventListener("scroll", (function() {
            if (!isRequestingAnimationFrame) {
                script_requestAnimationFrame(filterGoTopButtonVisibility);
                isRequestingAnimationFrame = true;
            }
        }));
        function filterGoTopButtonVisibility() {
            let windowPageYOffset = window.scrollY || document.documentElement.scrollTop;
    ...
    function loadVideo() {
        let container = document.querySelector(".about__video");
    ...
    if (animItems.length > 0) {
        ...
        function offset(el) {
            const rect = el.getBoundingClientRect(), scrollLeft = window.scrollY || document.documentElement.scrollLeft, scrollTop = window.scrollY || document.documentElement.scrollTop;
            return {
